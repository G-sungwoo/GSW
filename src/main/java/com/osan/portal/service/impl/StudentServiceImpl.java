...
public class StudentServiceImpl implements StudentService{
    ...
    public LoginInfo selectUser(LoginInfo loginInfo){
        return osanPortalSql.selectOne("selectUser", loginInfo);
    }

    public String selectEncPassword(LoginInfo loginInfo){
        return osanPortalSql.selectOne("selectEncPassword", loginInfo);
    }

    public LoginInfo selectUserForFindPassword(LoginInfo loginInfo){
        return osanPortalSql.selectOne("selectUserForFindPassword", loginInfo);
    }
	...
	@Override
	public SurveyInfo getSurveyInptYsno(StudentSearchInfo surveyFormInfo) {
		SurveyInfo resultgetSurveyInptYsno = osanPortalSql.selectOne("getSurveyInptYsno", surveyFormInfo);
		
		return resultgetSurveyInptYsno;
	}

	@Override
	public void updateLtevPtyn(SurveyInfo surveyInfo) {
		osanPortalSql.update("updateLtevPtyn",surveyInfo);
	}
