...
<%@ include file = "/resources/layout/header.jsp" %>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">${CourInfo.adpt_year}-${CourInfo.adpt_shtm}학기 중간 강의평가
                    ...
                    <form  action="" method="post" name="MidTermForm" id="MidTermForm" >
                        ...
                        <input name="lect_shtm" id="lect_shtm" type="hidden" value="${CourInfo.adpt_shtm}" />
                            ...
                            <tbody>
                                <c:forEach items="${MidTermList}" var="list">
                                    <tr>
    ...
    <script type="text/javascript">
            ...
            var sprfKrnm = $(this).closest("tr").find("#sprf_krnm").text();
        ...
        /* 강의평가 저장 */
        function saveMidTerm(obj){
            
            
        var formData = $("#midTermForm").serialize();
