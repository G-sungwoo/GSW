        ...
        function getBoardArticleOk(data, status){
        	...
        	if(len >0){ 
        		$(item).each(function(i, item){ 
        			...
        			selectHtml.push($("#encUserNo").val());
        			selectHtml.push('","');
        			selectHtml.push(item.articleSeq);
        			selectHtml.push('");>'+item.title+'</a></td>')
        			
        			selectHtml.push('<td>'+item.insertName+'</td>'); 
    ...
    <div class="article">
        <div id="left">
            ...
            <c:set var="tmpUserNo" value="<%=userNo %>"/>
                <li><a href="javascript:openMenu('https://ostory.osan.ac.kr/common/user/loginProc.do', 'ostory')"><strong><font color="blue">Ostory</font></strong></a></li>
                <c:if test="${tmpUserNo eq 'job421' || tmpUserNo eq 'job422' || tmpUserNo eq 'job423' || tmpUserNo eq 'job424'}">
                <li><a href="javascript:openMenu('https://ostory.osan.ac.kr/common/user/ssoLogin.do?ssoGb=OSTORY', 'ostory')"><strong>Ostory관리자</strong></a></li>
                </c:if>
                ...
                <li><a href="javascript:openMenu('/resources/sso/homepage_login.jsp?','8010300','')" id="homeLink" onfocus="blur()"><strong>홈페이지</strong></a></li>
            ...
            <div class="grid">
                ...
                <div class="grid-item grid-sizer grid-item-default">
                    ...
                    <div class="box">
                        <div class="info">
                            <ol class="btn left">
                                <li><button type="button" class="write" onclick="writeBoard('<%=encUserNo%>');">글쓰기</button></li>
                            </ol>
                            <div class="txt right">
                        ...
                        <table class="op_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${osanUniNewsList.viewCount}</td>
                                </c:forEach>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="grid-item">
                    ...
                    <div class="box">
                        <ol class="tab" id="hompageTab">
                            <li rel="tab1"><a class="on">대학공지</a></li>
                        ...
                        <div id="tab1" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/?menuno=135','','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=135','','')" title="" class="cut">${uniNoticeList.title}</a></td>
                                        <td>${uniNoticeList.regDate}</td>
                                        <td>${uniNoticeList.viewCount}</td>
                                    </c:forEach>
                                </tbody>
                            </table>
                        </div>
                        <div id="tab2" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/iphak/sub.asp?mode=view&idx=381','','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/iphak/sub.asp?mode=view&idx=381','','')" title="" class="cut">${iphakNoticeList.title}</a></td>
                                        <td>${iphakNoticeList.regDate}</td>
                                        <td>${iphakNoticeList.viewCount}</td>
                                    </c:forEach>
                                </tbody>
                            </table>
                        </div>
                        <div id="tab3" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/?menuno=139','','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=139','','')" title="" class="cut">${bidNoticeList.title}</a></td>
                                        <td>${bidNoticeList.regDate}</td>
                                        <td>${bidNoticeList.viewCount}</td>
                                    </c:forEach>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="box">
                        <div class="info">
                            <form class="search" id="searchWorkerForm" onsubmit="return false">
                                ...
                                <ol class="btn right">
                                    <li><button type="button" class="write" onclick="searchWorker();">검색</button></li>
                                </ol>
                            </form>
                        </div>
                        <table class="op_table">
                    ...
                    <div class="box">
                        <table class="op_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=135','','')" title="" class="cut">${osanUniQnAList.title}</a></td>
                                    <td>${osanUniQnAList.regDate}</td>
                                    <td>${osanUniQnAList.replyAt}</td>
                                </c:forEach>
                            </tbody>
                        </table>
                    </div>
