...
<head>
	...
	<script type="text/javascript">
        ...
        /*AD 비밀번호 변경*/
        function updateAdPassword(){
            var newPassword = $("#newPassword").val();
            var formData = $("#userPasswordForm").serialize() + "&USERID="+ $("#userNo").val() + "&PWD=" + newPassword;
            $.ajax({
                type : "GET",
                async : false,
                url : "https://ngw.osan.ac.kr/RequestChangePassword.aspx",
                data : formData,
                dataType : "jsonp",
                success : updateAdPasswordOk,
                error: updateAdPasswordOk
            });
        }
        /*비밀번호 수정 callback*/
        ...
        /*비밀번호 수정 callback*/
        function updateAdPasswordOk(data, status){
            if(data.status == "200"){
                alert("비밀번호가 변경되었습니다.");
                $('#userPasswordForm :input').val('');
                return;
        ...
        function openGroupWare(docDiv){
        	if(docDiv == '1'){
        		openMenu('http://gw.osan.ac.kr:8090/public/script/gwlogin_sso.jsp?fr=ptl&pmenu=sgn','gw','');
        	}else if(docDiv == '2'){
        		openMenu('http://gw.osan.ac.kr:8090/public/script/gwlogin_sso.jsp?fr=ptl&pmenu=sgn&smenu=ccl','gw','');
        	}else if(docDiv == '3'){
        		openMenu('http://gw.osan.ac.kr:8090/public/script/gwlogin_sso.jsp?fr=ptl&pmenu=sgn&smenu=rcv','gw','');
        	}else{
        		return;
        	}
        }
...
<div id="header">
    <div class="article">
        ...
        <ul class="tm">
            <li><a href="javascript:openMenu('/resources/sso/homepage_login.jsp','hompage','')"><strong>홈페이지</strong></a></li>
            <li><a href="javascript:gwMail()"><strong>웹메일 NEW</strong></a></li>
            <li><a href="javascript:gwMain()"><strong>그룹웨어 NEW</strong></a></li>
        </ul>
        <ul>
    ...
    <div class="article">
        <div id="left">
            ...
            <c:set var="userAuth" value="<%=userAuth %>"/>
                ...
                <li><a href="javascript:openMenu('https://osanuniv.osan.ac.kr/osu/brower_check.jsp', 'univIsTest')"><strong><font color="red">대학정보시스템</font></strong></a></li>
<!--                 <li><a href="javascript:openMenu('http://osanuniv.osan.ac.kr/osu/index_bandisso.jsp', 'univIs')"><strong>대학정보시스템</strong></a></li> -->
                <li><a href="javascript:openMenu('/resources/sso/homepage_login.jsp','hompage','')"><strong>홈페이지</strong></a></li>
                <li><a href="javascript:gwMain()"><strong><font color="red">그룹웨어 NEW</font></strong></a></li>
                <li><a href="javascript:gwMail()"><strong><font color="red">웹메일 NEW</font></strong></a></li>
                <li><a href="javascript:openMenu('http://gw.osan.ac.kr:8090/public/script/gwlogin_sso.jsp?fr=ptl&pmenu=main&smenu=','gw','')"><strong><font color="blue">(구)그룹웨어</font></strong></a></li>
<!--                 <li><a href="javascript:openMenu('/resources/sso/webmail_login.jsp', 'webmail','')"><strong><font color="blue">(구)웹메일</font></strong></a></li> -->
                <li><a href="javascript:openMenu('https://ostory.osan.ac.kr/common/user/ssoLogin.do', 'ostory')"><strong>학생이력관리시스템</strong></a></li>
                <li><a href="javascript:openMenu('https://lms.osan.ac.kr/osansso/login.php', 'lms')"><strong>LMS</strong></a></li>
                <li><a href="javascript:cbMain()"><strong>CB시스템/업적평가</strong></a></li>
                <c:if test="${tmpUserNo eq '2018718' || tmpUserNo eq '2017711' || tmpUserNo eq '2021705' || tmpUserNo eq '2017712' || userAuth eq '3' || tmpUserNo eq '2019720' || tmpUserNo eq '2022729' || tmpUserNo eq '2024706'}">
                <li><a href="javascript:attendMain('<%=userNo%>')"><strong>전자출결</strong></a></li>
                </c:if>
                <c:if test="${hjAt eq 'Y' || userAuth eq '3'}">
                <li><a href="javascript:openMenu('https://ojt.osan.ac.kr/login.do', 'ojt')"><strong>현장실습</strong></a></li>
                </c:if>
                <li><a href="javascript:openMenu('https://ctl.osan.ac.kr/ko/e_learning/rent/intro', 'reserve')"><strong><font color="red">통합예약시스템</font></strong></a></li>
                <li><a href="javascript:openMenu('https://ctl.osan.ac.kr/osansso/login.php', 'ctl')"><strong>교수학습지원센터</strong></a></li>
                <li><a href="javascript:openMenu('https://lib.osan.ac.kr', 'lib')"><strong>도서관</strong></a></li>
                <li><a href="javascript:openMenu('https://lifeedu.osan.ac.kr/html/index', 'lib')"><strong><font color="red">평생교육원 NEW</font></strong></a></li>
                <li><a href="javascript:openMenu('/resources/sso/yearend_RegGuide.jsp?fr=ptl&pmenu=sch&smenu=data1', 'yearTax')"><strong>연말정산</strong></a></li>
                <li><a href="javascript:openMenu('http://say.olleh.com/', 'sms')"><strong>SMS</strong></a></li>
<%--                 <c:if test="${shAt eq 'Y' || userAuth eq '3'}"> --%>
<!--                 <li><a href="javascript:openMenu('https://job.osan.ac.kr/inz/log-in.proc_2018.asp', 'sh')"><strong>학생취업처</strong></a></li> -->
<%--                 </c:if> --%>
                <c:if test="${cuAt eq 'Y'|| userAuth eq '3'}">
                <li><a href="javascript:openMenu('https://jobdb.osan.ac.kr:8443/jobs/login/sso_osan.jsp', 'job')"><strong>진로취업시스템</strong></a></li>
                </c:if>
                <c:if test="${pkAt eq 'Y'}">
                <li><a href="javascript:openMenu('https://lifeedu_old.osan.ac.kr:449/inz/log-in.proc_2018.asp', 'job')"><strong>평생교육원(구)</strong></a></li>
                </c:if>
                <li><a href="javascript:openMenu('http://as82.kr/osan/', 'remote')"><strong>원격지원</strong></a></li>
                <li><a href="javascript:openMenu('https://ostory.osan.ac.kr/common/user/ssoLogin.do?ssoGb=OSTORY', 'ostory')"><strong>학생이력관리시스템 관리자</strong></a></li>
                <c:if test="${hjAt eq 'Y' || userAuth eq '3'}">
                <li><a href="javascript:openMenu('https://ojt-old.osan.ac.kr/inz/log-in.proc_2018.asp', 'ojtOld')"><strong>(구)현장실습</strong></a></li>
                </c:if>
                <li><a href="javascript:openMenu('https://ncs.osan.ac.kr/NCS_V2/loginProcess', 'ncs')"><strong>NCS시스템</strong></a></li>
<%--                 <c:if test="${tmpUserNo eq '2018718' || tmpUserNo eq '2018728' || tmpUserNo eq '2017712' || tmpUserNo eq '1996707'}"> --%>
<!--                 <li><a href="javascript:openPopupAttandance();"><strong>(구)출결관리</strong></a></li> -->
<%--                 </c:if> --%>
                <li><a href="javascript:openMenu('https://iphak.osan.ac.kr/auth/ssoAuth.html', 'hpCMS')"><strong>입학홈페이지CMS</strong></a></li>
                <li><a href="javascript:openMenu('https://www.osan.ac.kr/login.html', 'hpCMS')"><strong>대학홈페이지CMS</strong></a></li>
                <li><a href="javascript:openMenu('https://kedi.osan.ac.kr:8080/login/page/index', 'kedi')"><strong>통계정보시스템</strong></a></li>
            </ol>
        </div>
        <div id="right">
            <div class="grid">
                <div class="grid-item grid-item-width2 swiper-container swiper-image grid-item-default">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="resources/img/main_img04.jpg" alt="이미지" /></div>
                ...
                <div class="grid-item login">
                    ...
                    <div class="box">
                        <div class="info"><strong>최근 접속일시:</strong> 2024/04/05 오전 11:43:22<br /><strong>접속 IP:</strong>211.221.232.238</div>
                    </div>
                </div>
                <div class="grid-item">
                    <h3>
                    ...
                    <div class="box">
                        <table class="op_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <c:choose>
                                    <c:when test="${osanUniNewsList.boardNo eq '608'}">
                                    <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=137','homepage','')" title="" class="cut">${osanUniNewsList.title}</a></td>
                                    </c:when>
                                    <c:otherwise>
                                    <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=400','homepage','')" title="" class="cut">${osanUniNewsList.title}</a></td>
                                    </c:otherwise>
                                    </c:choose>
                ...
                <div class="grid-item">
                    <h3>홈페이지 공지사항<span>&nbsp;</span>
                    </h3>
                    <div class="box">
                        <ol class="tab" id="hompageTab">
                            <li rel="tab1"><a>대학공지</a></li>
                            <li rel="tab2"><a>입시공지</a></li>
                            <li rel="tab3"><a>입찰공지</a></li>
                            <li rel="tab7"><a class="on">코로나19</a></li>
                        </ol>
                        <div id="tab1" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/?menuno=135','homepage','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    <c:forEach items="${uniNoticeList}" var="uniNoticeList">
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=135','homepage','')" title="" class="cut">${uniNoticeList.title}</a></td>
                                        <td>${uniNoticeList.regDate}</td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div id="tab2" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://iphak.osan.ac.kr/?menuno=517','iphak','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    <c:forEach items="${iphakNoticeList}" var="iphakNoticeList">
                                    <tr>
                                        <td><a href="javascript:openMenu('https://iphak.osan.ac.kr/?menuno=517','iphak','')" title="" class="cut">${iphakNoticeList.title}</a></td>
                                        <td>${iphakNoticeList.regDate}</td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div id="tab3" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/?menuno=139','homepage','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    <c:forEach items="${bidNoticeList}" var="bidNoticeList">
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=139','homepage','')" title="" class="cut">${bidNoticeList.title}</a></td>
                                        <td>${bidNoticeList.regDate}</td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div id="tab7" class="tab_content">
                            <div class="info">
                                <ol class="btn right">
                                    <li><button type="button" onclick="openMenu('https://www.osan.ac.kr/?menuno=596','homepage','')" style="cursor:pointer">+MORE</button></li>
                                </ol>
                            </div>
                            <table class="op_table">
                                <colgroup>
                                ...
                                <tbody>
                                    <c:forEach items="${coronaNoticeList}" var="coronaNoticeList">
                                    <tr>
                                        <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=596','homepage','')" title="" class="cut">${coronaNoticeList.title}</a></td>
                                        <td>${coronaNoticeList.regDate}</td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
...
<!--                             <thead> -->
<!--                                 <tr> -->
<!--                                     <td colspan="2">그룹웨어</td> -->
<!--                                 </tr> -->
<!--                             </thead> -->
<!--                             <tbody> -->
<!--                                 <tr> -->
<!--                                     <td>결재건수</td> -->
<!--                                     <td id="signDocCnt" class="ra"></td> -->
<!--                                 </tr> -->
<!--                                 <tr> -->
<!--                                     <td>공람건수</td> -->
<!--                                     <td id="publicDocCnt" class="ra"></td> -->
<!--                                 </tr> -->
<!--                                 <tr> -->
<!--                                     <td>수신함건수</td> -->
<!--                                     <td id="inboxDocCnt" class="ra"></td> -->
<!--                                 </tr> -->
<!--                             </tbody> -->
<!--                         </table> -->
<!--                     </div> -->
<!--                 </div> -->
               <div class="grid-item">
                    ...
                    <div class="box">
                        <div class="info">
                            <form class="search" id="searchWorkerForm" onsubmit="return false">
                                <div class="txt left">
                                    <input type="text" name="searchName" id="searchName" value="" placeholder="성명을 입력해주세요" />
                                </div>
                                <ol class="btn right">
                                    <li><button type="button" class="write" onclick="searchWorker();" style="height:23px;">검색</button></li>
                                </ol>
                            </form>
                        </div>
                        <table class="op_table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <td class="ct">구분</td>
                                    <td class="ct">교내번호</td>
                                    <td class="ct">핸드폰번호</td>
                                </tr>
                            </thead>
                            <tbody id="searchWorkerList">
                                <tr>
                                    <td colspan="5" class="ct">조회된 결과가 없습니다.</td>
                                </tr>
                            </tbody>
                        </table>
                        <div class=paging id="searchWorkerPaging">
                        </div>
                    </div>
                </div>
                <div class="grid-item">
                    ...
                    <div class="box">
                        <table class="op_table">
                            ...
                            <tbody>
                                <c:forEach items="${osanUniQnAList}" var="osanUniQnAList">
                                <tr>
                                    <td><a href="javascript:openMenu('https://www.osan.ac.kr/?menuno=260','homepage','')" title="" class="cut">${osanUniQnAList.title}</a></td>
                                    <td>${osanUniQnAList.regDate}</td>
                                    <c:choose>
                                        <c:when test="${osanUniQnAList.replyAt eq '답변완료'}">
                                            <td class="ct" style="color:blue">${osanUniQnAList.replyAt}</td>
                                        </c:when>
                                        <c:otherwise>
                                             <td class="ct" style="color:red">${osanUniQnAList.replyAt}</td>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </tbody>
                ...
                <div class="grid-item">
                    ...
                    <div class="box">
                        ...
                        <div id="tab5" class="tab_user">
                            ...
                            <div class="info">※ 비밀번호는 영문, 숫자, 특수문자(%, #제외)를 혼합하여 8~12자리 이내로 입력해주세요.</div>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="grid-item">
                    ...
                    <div class="box">
                        <div class="calendar">
                            <a href="javascript:getAcademicSchedule('prev')" class="prev"><img src="resources/img/calendar_left.png" alt="이전일정" />이전일정</a>
                            <strong id="currentYm">년 월</strong>
                            <a href="javascript:getAcademicSchedule('next')" class="next">다음일정<img src="resources/img/calendar_right.png" alt="다음일정" /></a>
                        </div>
                        <table class="op_table">
                            <colgroup>
                                <col style="width:33%; " />
                ...
                <div class="grid-item">
                    ...
                    <div class="box">
                        <div class="swiper-container swiper-banner">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><A href="resources/sso/UCMLite_Guide.jsp?fr=ptl&pmenu=sch&smenu=data1" target=_blank><img src="resources/img/office365_small.jpg" alt="Office 365 Student Advantage Program 학생들의 스마트한 학교생활을 위해 오산대학교, Microsoft가 함께 학생들에게 제공하는  프로그램 바로가기" /></A></div>
                            </div>
                            <div class="swiper-pagination"></div>
                            <script>
