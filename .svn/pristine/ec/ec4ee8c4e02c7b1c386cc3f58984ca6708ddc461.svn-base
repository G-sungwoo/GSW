...
//             }
        ...
        function onSuccess(data, status){
            if(data == "NOT_EXIST_USER"){
                ...
                alert("비밀번호가 일치 하지 않습니다. 9회 이상 비밀번호를 잘못 입력할 경우 계정이 잠금처리 됩니다.");
                return;
            	...
            	alert("9회 이상 잘못된 비밀번호를 입력하여 계정이 잠금처리 되었습니다. 관리자에게 문의해주세요. TEL: 031-370-2625");
            	return;
...
<body>
    ...
    <div class="login_box">
        <div style="background:url('resources/img/opred.png') repeat">
            ...
            <font color="blue"><p style="font-weight: bold">대학정보시스템은 인터넷 익스플로러에서만 실행 가능합니다.</p></font>
            <a href="resources/img/대학정보시스템_가이드.pdf" target="_blank"><font color="purple"><p>대학정보시스템 설치 및 접속 가이드 </p></font></a>
