...
<head>
	...
	<script type="text/javascript">
        ...
        function openLectPlanReport(PARAM){
        	...
        	$("#param").val(PARAM);
        	$("#lectPlanReportForm").attr("action", "https://osanuniv.osan.ac.kr/osu/lect_plan.jsp");
...
<!--                 <li><a href="javascript:openMenu('https://ncs.osan.ac.kr/NCS_V2/loginProcess', 'ncs')"><strong>NCS시스템</strong></a></li> -->
                ...
                <li><a href="javascript:openMenu('https://ostory.osan.ac.kr/common/user/ssoLogin.do?ssoGb=OSTORY', 'ostory')"><strong>OStory!관리자</strong></a></li>
                <c:if test="${tmpUserNo eq '2003079'}">
                <li><a href="javascript:openMenu('https://ncs.osan.ac.kr/NCS_V2/loginProcess', 'ncs')"><strong>NCS시스템</strong></a></li>
                </c:if>
                <li><a href="javascript:openMenu('https://iphak.osan.ac.kr/auth/ssoAuth.html', 'hpCMS')"><strong>홈페이지CMS</strong></a></li>
            </ol>
        </div>
        <div id="right">
            <div class="grid">
                    ...
                    <div class="box">
                        ...
                        <table class="op_table">
                            ...
                            <c:forEach items="${lectPlanList}" var="lectPlanList">
                                <tr>
                                    <td class="ct">${lectPlanList.haksNumb}</td>
                                    <td class="ct">${lectPlanList.corsShyr}</td>
                                    <td class="ct">${lectPlanList.clssNumb}</td>
                                    <td><a href="javascript:openLectPlanReport('[${lectPlanList.lectYear}] [${lectPlanList.lectShtm}] [${lectPlanList.corsSust}] [${lectPlanList.corsMajr}] [${lectPlanList.lincYsno}] [${lectPlanList.haksNumb}] [${lectPlanList.haksNumb2}]');"> ${lectPlanList.sbjtKrnm}</a></td>
                                    <td class="ct">${lectPlanList.sprfKrnm}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
