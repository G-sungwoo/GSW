...
public class KISA_SEED_CBC {
	...
	private static final byte[] key = { 0x00, 0x68, 0x00, 0x61, 0x00, 0x70, 0x00, 0x70, 0x00, 0x79, 0x00, 0x38, 0x00, 0x30, 0x00, 0x33 };
	...
	/* decode 로직은 추가로 생성해서 사용.
	 * */
	public static String decodeSEED(String strCipherText) {
	    try {
	    	byte[] cipherText = Base64.decodeBase64(strCipherText.trim());
	        byte[] plainText = SEED_CBC_Decrypt(key, iv, cipherText, 0, cipherText.length);
