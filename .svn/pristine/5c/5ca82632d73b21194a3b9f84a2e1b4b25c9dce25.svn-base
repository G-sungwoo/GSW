...
public class MainServiceImpl implements MainService{
    ...
    public List<HomePageInfo> selectListHomepageStudentNotice(LoginInfo loginInfo){
    	return osanHomePageSql.selectList("selectListHomepageStudentNotice", loginInfo);
    }
	...
	public String getregiInfo(LoginInfo loginInfo) {
		// TODO Auto-generated method stub
		return osanPortalSql.selectOne("getregiInfo",loginInfo);
	}

	public void updateregiInfo(LoginInfo loginInfo) {
		osanPortalSql.update("updateregiInfo",loginInfo);
	}
	
	public int updatezeroregi(LoginInfo loginInfo) {
		return osanPortalSql.update("updatezeroregi",loginInfo);
	}
